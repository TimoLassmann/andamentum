...
- **article** — warm serif article (Source Serif 4 + Inter)
- **cv** — monochrome compact (Inter + JetBrains Mono)
- **report** — blue technical (Inter + Space Grotesk + JetBrains Mono)
"""

from __future__ import annotations

# ---------------------------------------------------------------------------
# ARTICLE — warm, readable, centered serif article
# ---------------------------------------------------------------------------

ARTICLE: str = """\
@import url('https://fonts.googleapis.com/css2?\
family=Source+Serif+4:ital,opsz,wght@0,8..60,300;0,8..60,400;0,8..60,600;\
0,8..60,700;1,8..60,400\
...
.typeset-prose tr:nth-child(even) {
    background: #f4f1ec;
}
...
@media print {
    ...
    .typeset-sidebar { display: none; }
    h1, h2, h3 { page-break-after: avoid; }
    .typeset-reference,
    .typeset-card { page-break-inside: avoid; }
...
@media (max-width: 600px) {
    .typeset-document { padding: 32px 16px; }
    .typeset-heading h1 { font-size: 26px; }
    .typeset-sidebar { grid-template-columns: 1fr; }
}
"""
