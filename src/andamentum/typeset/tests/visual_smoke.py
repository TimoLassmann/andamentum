...
SAMPLE_DOC = [
    {
        ...
        "subtitle": "Typeset visual test",
        "meta": {"date": "2026-04-16", "author": "Test"},
    },
    {
        "kind": "callout",
        ...
        "entries": [
            {
                ...
                "body": "The effect of **metformin** on cardiovascular mortality.",
            },
            {
                "label": "What did we find?",
                "body": "Mixed evidence across populations.",
            },
    ...
    {
        "kind": "card",
        "content": "Metformin lowers CK-MB biomarker levels.",
        "badge": "challenged",
    ...
    {
        "kind": "reference",
        "content": "Meta-analysis of cardiac biomarkers found significant CK-MB reduction.",
        "number": 2,
    ...
    {
        "kind": "reference",
        "content": "Systematic review found no significant MACE reduction.",
        "number": 3,
    ...
    },
    {
        ...
        "entries": [
            {
                "label": "2024",
                "body": "Deep Learning in Genomics. Australian Bioinformatics Conference.",
            },
            {
                "label": "2023",
                "body": "Introduction to Bioinformatics. University of Western Australia.",
            },
        ],
    },
    {
        "kind": "callout",
        "content": "**Warning:** This data has not been peer-reviewed.",
        "tone": "warning",
    },
