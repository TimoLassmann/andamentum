...
class Snapshot(EpistemicEntity):
    ...
    claim_ids: list[str] = Field(
        ...
        description="Claims included at their current stages"
    )
    ...
    evidence_ids: list[str] = Field(
        default_factory=list,
        description="All evidence referenced by included claims"
    )
    ...
    artefact_id: Optional[str] = Field(
        default=None,
        description="ID of artefact generated from this snapshot"
    )
    frozen: bool = Field(
        default=True,
        description="Snapshots are immutable once created"
    )
