...
from andamentum.whetstone.nodes.reflect_and_investigate import (
    _apply_investigator_result,
    _run_reflection,
    _run_investigation,
)
from andamentum.whetstone.schemas import Finding, Quote, SectionCard
...
async def test_run_reflection_prompt_includes_pool_and_history() -> None:
    ...
    with patch(
        "andamentum.whetstone.nodes.reflect_and_investigate.build_pydantic_ai_agent",
        return_value=fake,
    ):
