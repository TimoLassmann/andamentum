...
from andamentum.whetstone.agents.novelty_claim_extractor import (
    NoveltyClaim,
    NoveltyClaimList,
)
from andamentum.whetstone.deps import ReviewDeps
from andamentum.whetstone.nodes.novelty_check import (
    NoveltyCheck,
    _report_to_finding,
)
...
async def test_extracts_then_calls_deep_research(tmp_path: Path):
    ...
    from andamentum.whetstone.nodes import novelty_check as nc_mod
