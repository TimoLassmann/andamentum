...
from andamentum.whetstone.dynamic_schemas import create_custom_evaluation_model
from andamentum.whetstone.nodes.custom_reviewer import CustomReviewer
...
class TestCustomReviewerNode:
    async def test_runs_one_call_with_dynamic_schema(self) -> None:
        ...
        with mock.patch(
            "andamentum.whetstone.nodes.custom_reviewer.build_dynamic_output_agent",
...
async def test_e2e_custom_mode() -> None:
    ...
    import andamentum.whetstone.nodes.custom_reviewer as cr_mod
