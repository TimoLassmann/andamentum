...
from andamentum.whetstone.v2.agents import ExtractedItemsList
from andamentum.whetstone.v2.deps import ReviewDeps
from andamentum.whetstone.v2.nodes.evaluate_guideline_items import (
    EvaluateGuidelineItems,
)
from andamentum.whetstone.v2.nodes.extract_checkable_items import (
    ExtractCheckableItems,
)
from andamentum.whetstone.v2.schemas import SectionCard
...
class TestExtractCheckableItemsNode:
    async def test_extracts_items_from_agent(self) -> None:
        ...
        with mock.patch(
            "andamentum.whetstone.v2.nodes.extract_checkable_items.build_pydantic_ai_agent",
            return_value=fake,
        ):
...
class TestEvaluateGuidelineItemsNode:
    async def test_runs_one_evaluation_per_item(self) -> None:
        ...
        with mock.patch(
            "andamentum.whetstone.v2.nodes.evaluate_guideline_items.build_pydantic_ai_agent",
...
async def test_e2e_guidelines_mode(guidelines_canned: dict[str, Any]) -> None:
    ...
    import andamentum.whetstone.v2.nodes.evaluate_guideline_items as eg_mod
    import andamentum.whetstone.v2.nodes.extract_checkable_items as ex_mod
