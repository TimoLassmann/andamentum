...
_IRREGULAR_PARTICIPLES = (
    "arisen", "awoken", "been", "borne", "born",
    "beaten", "become", "begun", "bent", "bet",
    "bidden", "bitten", "bled", "blown", "broken",
    "brought", "built", "burnt", "burst", "bought",
    "caught", "chosen", "clung", "come", "cost",
    "crept", "cut", "dealt", "dug", "done",
    "drawn", "dreamt", "driven", "drunk", "eaten",
    "fallen", "fed", "felt", "fought", "found",
    "fled", "flown", "forbidden", "forgotten", "forgiven",
    "frozen", "given", "gone", "grown", "hung",
    "had", "heard", "hidden", "hit", "held",
    "hurt", "kept", "knelt", "known", "laid",
    "led", "leapt", "learnt", "left", "lent",
    "let", "lain", "lost", "made", "meant",
    "met", "paid", "proven", "put", "quit",
    "read", "ridden", "risen", "run", "said",
    "seen", "sold", "sent", "set", "shaken",
    "shed", "shone", "shot", "shown", "shut",
    "sung", "sunk", "sat", "slept", "slid",
    "spoken", "spent", "spread", "stood", "stolen",
    "struck", "sworn", "swept", "swum", "swung",
    "taken", "taught", "torn", "told", "thought",
    "thrown", "trodden", "understood", "woken", "worn",
    "won", "written",
)
