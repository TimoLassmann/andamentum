...
# Run the full test suite (859 tests default, asyncio_mode=auto)
...
The canonical green state: **pyright 0 errors, ruff clean, pytest 859 passing (1 benchmark deselected)**. Don't claim completion until you've run these three and seen that state.
